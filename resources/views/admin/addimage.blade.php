        ...
        <div class="col-sm-12">
          ...
          <form action="{{route('image.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label for="quze">Answer one</label>
